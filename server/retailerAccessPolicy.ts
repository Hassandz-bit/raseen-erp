export const retailerPermissions = [
  "retail.catalog.view", "retail.prices.view", "retail.promotions.view", "retail.orders.view", "retail.orders.create", "retail.orders.cancel", "retail.returns.create", "retail.invoices.view", "retail.delivery_notes.view", "retail.statement.view", "retail.debt.view", "retail.outlets.view", "retail.outlets.manage", "retail.users.manage",
] as const;
...
const rolePermissions: Record<RetailerRole, ReadonlySet<RetailerPermission>> = {
  ...
  buyer: new Set<RetailerPermission>(["retail.catalog.view", "retail.prices.view", "retail.promotions.view", "retail.orders.view", "retail.orders.create", "retail.orders.cancel", "retail.returns.create", "retail.outlets.view"]),
  ...
  store_manager: new Set<RetailerPermission>(["retail.catalog.view", "retail.prices.view", "retail.promotions.view", "retail.orders.view", "retail.orders.create", "retail.orders.cancel", "retail.returns.create", "retail.outlets.view"]),
