  ...
  return <div dir={direction} className="nawa-app-shell">
    <header className="nawa-global-header nawa-command-bar">
      <div className="nawa-command-leading">
        ...
        <button type="button" onClick={() => navigate("/")} className="nawa-wordmark" aria-label={chrome.portals}><span className="nawa-wordmark-mark">R</span><span className="hidden text-sm font-black tracking-tight sm:inline">RASEEN ERP</span></button>
