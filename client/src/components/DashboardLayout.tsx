...
const portalChrome = {
  ar: { portals: "كل البوابات", executive: "الملخص التنفيذي", workspace: "مساحة العمل", tools: "أدوات البوابة", notifications: "التنبيهات", markAllRead: "تحديد الكل كمقروء", emptyNotifications: "لا توجد تنبيهات حديثة", ai: "Nawa AI", demo: "بيانات Demo", portalSearch: "ابحث عن منتج، عميل، طلب، فاتورة أو صفحة...", searchTools: "ابحث في أدوات هذه البوابة", commandTitle: "أوامر Nawa", commandDescription: "انتقل إلى بوابة أو أداة متاحة لك", pages: "الصفحات والأدوات", quickCreate: "إنشاء", quickCreateHint: "إجراء سريع في البوابة الحالية", noQuickCreate: "لا توجد إجراءات سريعة لهذه البوابة", pinNav: "تثبيت التنقل الموسع", unpinNav: "العودة للوضع التلقائي", navAuto: "تلقائي", navExpanded: "موسع", navCompact: "مضغوط", defaultBranch: "الفرع الافتراضي", profile: "الملف الشخصي", preferences: "التفضيلات", settings: "الإعدادات", noResults: "لا توجد صفحات أو أدوات مطابقة", operational: "وضع العمل", discovery: "استكشاف البوابة" },
  fr: { portals: "Tous les portails", executive: "Vue exécutive", workspace: "Espace de travail", tools: "Outils du portail", notifications: "Notifications", markAllRead: "Tout marquer comme lu", emptyNotifications: "Aucune notification récente", ai: "Nawa AI", demo: "Données Demo", portalSearch: "Rechercher un produit, client, commande, facture ou page…", searchTools: "Rechercher dans les outils du portail", commandTitle: "Commandes Nawa", commandDescription: "Accédez à un portail ou outil autorisé", pages: "Pages et outils", quickCreate: "Créer", quickCreateHint: "Action rapide du portail actuel", noQuickCreate: "Aucune action rapide pour ce portail", pinNav: "Épingler la navigation développée", unpinNav: "Revenir au mode automatique", navAuto: "Automatique", navExpanded: "Développé", navCompact: "Compact", defaultBranch: "Branche par défaut", profile: "Profil", preferences: "Préférences", settings: "Paramètres", noResults: "Aucune page ou outil correspondant", operational: "Mode travail", discovery: "Découvrir le portail" },
  en: { portals: "All portals", executive: "Executive overview", workspace: "Workspace", tools: "Portal tools", notifications: "Notifications", markAllRead: "Mark all as read", emptyNotifications: "No recent notifications", ai: "Nawa AI", demo: "Demo data", portalSearch: "Search a product, customer, order, invoice, or page…", searchTools: "Search this portal's tools", commandTitle: "Nawa commands", commandDescription: "Navigate to a portal or tool available to you", pages: "Pages & tools", quickCreate: "Create", quickCreateHint: "Quick action for the current portal", noQuickCreate: "No quick actions for this portal", pinNav: "Pin expanded navigation", unpinNav: "Return to auto mode", navAuto: "Auto", navExpanded: "Expanded", navCompact: "Compact", defaultBranch: "Default branch", profile: "Profile", preferences: "Preferences", settings: "Settings", noResults: "No matching pages or tools", operational: "Work mode", discovery: "Explore portal" },
} as const;
...
function DashboardLayoutContent({ children }: { children: ReactNode }) {
  ...
  return <div dir={direction} className="nawa-app-shell">
    <header className="nawa-global-header nawa-command-bar">
      <div className="nawa-command-leading">
        ...
        {!isPortalLauncher && activePortal ? <button type="button" onClick={() => navigate(activePortal.href)} className="nawa-current-portal"><PortalIcon className="h-4 w-4 shrink-0" /><span className="max-w-20 truncate text-[10px] font-bold sm:max-w-28 sm:text-xs lg:max-w-40">{activePortal.name[language]}</span></button> : null}
      ...
      <button type="button" onClick={() => setCommandOpen(true)} className="nawa-command-trigger" aria-label={chrome.portalSearch}><Search className="h-4 w-4 shrink-0" /><span className="truncate">{chrome.portalSearch}</span><kbd className="hidden shrink-0 lg:inline-flex">⌘K</kbd></button>
    ...
    <div className={`nawa-shell-body ${isPortalLauncher ? "nawa-shell-body-launcher" : ""}`}>
      ...
      <div className="nawa-workspace"><div className="nawa-workspace-inner">{!isPortalLauncher && activeMenuItem ? <div className="nawa-page-context"><span className="text-primary">{activePortal?.name[language]}</span><ChevronLeft className="h-3.5 w-3.5 text-muted-foreground" /><span>{activeMenuItem.label[language]}</span></div> : null}{children}</div></div>
    </div>
  </div>;
}
