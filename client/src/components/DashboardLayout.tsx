        ...
        >
          ...
          <SidebarContent ref={portalScrollRef} className="min-h-0 gap-0 overscroll-contain overflow-y-auto">
            <SidebarMenu className="px-2 py-3">
              ...
              <SidebarMenuItem><SidebarMenuButton onClick={() => navigateTo("/settings", chrome.settings)} tooltip={chrome.settings} className="h-12 text-[16px] font-semibold min-[600px]:h-14 min-[600px]:text-[18px]"><Settings2 className="h-5 w-5" /><span>{chrome.settings}</span></SidebarMenuButton></SidebarMenuItem>
