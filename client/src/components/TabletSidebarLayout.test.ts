...
describe("لوحة الشريط في الوضع اللوحي", () => {
  it("تستخدم عرضاً آمناً ولوحة بارتفاع الشاشة مع احتواء التمرير", () => {
    expect(sidebarSource).toContain('const SIDEBAR_WIDTH_MOBILE = "var(--nawa-tablet-sidebar-width, min(88vw, 26rem))"');
  ...
  it("يثبت الرأس والتذييل ويجعل قائمة الأدوات هي منطقة التمرير الوحيدة", () => {
    ...
    expect(layoutSource).toContain('SidebarContent ref={portalScrollRef} className="min-h-0 gap-0 overscroll-contain overflow-y-auto"');
