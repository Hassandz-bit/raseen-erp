...
export const nawaPortals: NawaPortal[] = [
  ...
  },
  {
    ...
    localNavigation: [
      ...
      { id: "accesses", label: text("علاقات التجار", "Relations détaillants", "Retailer relationships"), href: "/retail/accesses", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "outlets", label: text("منافذ التجار", "Points de vente", "Retailer outlets"), href: "/retail/outlets", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "retail-users", label: text("مستخدمو التجار", "Utilisateurs détaillants", "Retail users"), href: "/retail/users", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "promotions", label: text("عروض B2B", "Offres B2B", "B2B promotions"), href: "/retail/promotions", group: text("العروض", "Offres", "Promotions") },
      { id: "retail-orders", label: text("طلبات Retail", "Commandes Retail", "Retail orders"), href: "/retail/orders", group: text("الطلبات", "Commandes", "Orders") },
