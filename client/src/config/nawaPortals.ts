...
export const nawaPortals: NawaPortal[] = [
  ...
  },
  {
    ...
    localNavigation: [
      ...
      { id: "consumption", label: text("صرف المواد", "Consommation", "Material consumption"), href: "/manufacturing?tab=consumption", group: text("التشغيل", "Exécution", "Execution") },
      { id: "stages", label: text("المراحل", "Étapes", "Stages"), href: "/manufacturing?tab=stages", group: text("التشغيل", "Exécution", "Execution") },
      { id: "output", label: text("المخرجات", "Produits finis", "Production output"), href: "/manufacturing?tab=output", group: text("التشغيل", "Exécution", "Execution") },
      ...
      { id: "costs", label: text("تكاليف الإنتاج", "Coûts de production", "Production costs"), href: "/manufacturing?tab=costs", group: text("الرقابة", "Contrôle", "Control") },
    ],
  },
  {
    id: "distribution",
  ...
  },
  {
    ...
    localNavigation: [
      ...
      { id: "accesses", label: text("علاقات التجار", "Relations détaillants", "Retailer relationships"), href: "/b2b-orders#accesses", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "outlets", label: text("منافذ التجار", "Points de vente", "Retailer outlets"), href: "/b2b-orders#outlets", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "retail-users", label: text("مستخدمو التجار", "Utilisateurs détaillants", "Retail users"), href: "/b2b-orders#users", group: text("إدارة Retail", "Gestion Retail", "Retail administration") },
      { id: "promotions", label: text("عروض B2B", "Offres B2B", "B2B promotions"), href: "/b2b-orders#promotions", group: text("العروض", "Offres", "Promotions") },
      { id: "retail-orders", label: text("طلبات Retail", "Commandes Retail", "Retail orders"), href: "/b2b-orders#orders", group: text("الطلبات", "Commandes", "Orders") },
      { id: "returns", label: text("طلبات الإرجاع", "Demandes de retour", "Return requests"), href: "/b2b-orders#returns", group: text("الطلبات", "Commandes", "Orders") },
  ...
  },
  {
    ...
    localNavigation: [
      ...
      { id: "overtime", label: text("العمل الإضافي", "Heures supplémentaires", "Overtime"), href: "/hr?tab=overtime", group: text("الوقت والإجازات", "Temps et congés", "Time & leave") },
