...
const labels: Record<RetailSection, { ar: string; fr: string; en: string; description: { ar: string; fr: string; en: string }; anchor: string }> = {
  ...
  users: { ar: "مستخدمو Retail", fr: "Utilisateurs Retail", en: "Retail users", description: { ar: "جدول مستخدمي التجار وأدوارهم وحالة علاقتهم.", fr: "Utilisateurs des détaillants, rôles et statut de relation.", en: "Retailer users, roles, and relationship status." }, anchor: "users" },
  ...
  orders: { ar: "طلبات Retail", fr: "Commandes Retail", en: "Retail orders", description: { ar: "جدول طلبات التجار وحالات المراجعة والتحويل.", fr: "Commandes détaillants, revue et conversion.", en: "Retailer orders, review, and conversion status." }, anchor: "orders" },
...
export default function RetailSectionPage() {
  ...
  const copy = language === "ar" ? { manage: "فتح مركز إدارة Retail", refresh: "تحديث", retry: "إعادة المحاولة", empty: "لا توجد بيانات قابلة للعرض حالياً.", error: "تعذر تحميل بيانات Retail. تحقق من الاتصال ثم أعد المحاولة.", customer: "التاجر", status: "الحالة", role: "الدور", priceList: "قائمة الأسعار", user: "المستخدم", code: "الرمز", name: "الاسم", address: "العنوان", product: "المنتج", type: "النوع", period: "الفترة", order: "الطلب", amount: "القيمة", reason: "السبب", action: "الإجراءات" } : language === "fr" ? { manage: "Ouvrir la gestion Retail", refresh: "Actualiser", retry: "Réessayer", empty: "Aucune donnée à afficher.", error: "Impossible de charger les données Retail. Vérifiez la connexion puis réessayez.", customer: "Détaillant", status: "Statut", role: "Rôle", priceList: "Liste de prix", user: "Utilisateur", code: "Code", name: "Nom", address: "Adresse", product: "Produit", type: "Type", period: "Période", order: "Commande", amount: "Montant", reason: "Motif", action: "Actions" } : { manage: "Open Retail management", refresh: "Refresh", retry: "Try again", empty: "No data available yet.", error: "Retail data could not be loaded. Check the connection and try again.", customer: "Retailer", status: "Status", role: "Role", priceList: "Price list", user: "User", code: "Code", name: "Name", address: "Address", product: "Product", type: "Type", period: "Period", order: "Order", amount: "Amount", reason: "Reason", action: "Actions" };
