...
import { Boxes, ChevronLeft, Eye, Loader2, PackageSearch, ReceiptText, RefreshCw, ShoppingCart, Warehouse } from "lucide-react";
...
export default function CommerceSectionPage() {
  ...
  const labels = language === "ar" ? { search: "ابحث في الجدول", refresh: "تحديث البيانات", openCenter: "فتح مركز العمليات", count: "سجل", empty: "لا توجد بيانات مطابقة.", scrollHint: "اسحب أفقياً لرؤية جميع الأعمدة", name: "الاسم", code: "الرمز", price: "السعر", status: "الحالة", quantity: "الكمية", expiry: "الصلاحية", document: "المستند", total: "الإجمالي", details: "التفاصيل", selected: "دفعات محددة", activate: "تفعيل", block: "حظر", quarantine: "حجر" } : language === "fr" ? { search: "Rechercher dans le tableau", refresh: "Actualiser", openCenter: "Ouvrir le centre opérationnel", count: "lignes", empty: "Aucune donnée correspondante.", scrollHint: "Faites glisser pour voir toutes les colonnes", name: "Nom", code: "Code", price: "Prix", status: "Statut", quantity: "Quantité", expiry: "Expiration", document: "Document", total: "Total", details: "Détails", selected: "lots sélectionnés", activate: "Activer", block: "Bloquer", quarantine: "Quarantaine" } : { search: "Search this table", refresh: "Refresh data", openCenter: "Open operations center", count: "rows", empty: "No matching data.", scrollHint: "Swipe to view all columns", name: "Name", code: "Code", price: "Price", status: "Status", quantity: "Quantity", expiry: "Expiry", document: "Document", total: "Total", details: "Details", selected: "selected batches", activate: "Activate", block: "Block", quarantine: "Quarantine" };
